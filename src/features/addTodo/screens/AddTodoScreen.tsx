...
import { setIsShowDatePicker } from "../slices";
...
const AddTaskScreen = () => {
  ...
  const { isLoadingAddTodo, isShowDatePicker } = useAppSelector(
    (state) => state.addTask,
  );
  const navigation = useNavigation<StackNavigationProp<RootStackParams>>();

  const { methods, handleAddTask, handleDateChange } = useAddTodoViewModel();
              ...
              render={({ field: { value } }) => (
                <VStack>
                  <HStack justifyContent="space-between" alignItems="center">
                    ...
                    <TextView
                      onPress={() => dispatch(setIsShowDatePicker(true))}
                    >
                      {value
